										...
										<view class="ml-20 flex-1 flex-col justify-between">
											...
											<view class="flex-between-center "
												...
												<view class="flex-y-center pr-24 text--w111-333">
													<text class="iconfont icon-ic_Reduce fs-24 h-36 pr-12 pl-12 flex-center" @click.stop='subCart(jindex,index)'></text>
													...
													<text class="iconfont icon-ic_increase fs-24 h-36 pr-12 pl-12 flex-center" @click.stop='addCart(jindex,index,item)'></text>
												</view>
											</view>
