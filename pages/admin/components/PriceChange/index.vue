		...
		<view class="priceChange" :class="[change === true ? 'on' : '']">
			<view class="priceChange-box">
				...
				<view class="listChange" v-if="status == 2">
					...
					<view class="item" v-if="isAgree && isRefund">
						...
						<view class="acea-row row-right text--w111-e93323 fs-24">（包含邮费：￥{{pay_postage || 0}}）</view>
					</view>
	...
	export default {
		...
		watch: {
			orderInfo: function(nVal) {
				...
				this.pay_postage = this.orderInfo.pay_postage;
