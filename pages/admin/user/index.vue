	...
	<view class="user-details">
		...
		<view class="list">
			...
			<view class="item acea-row row-between-wrapper">
				...
				<view class="not" v-else>{{infoData.group_name || '无'}}</view>
			</view>
			<view class="item acea-row row-between-wrapper">
				<view>等级</view>
				<view v-if="types">
				...
				<view class="not" v-else>{{infoData.level_name || '无'}}</view>
			</view>
			<view class="item">
				<view class="acea-row row-between-wrapper">
					<view>标签</view>
					<view class="add" @click="editLabels" v-if="types"><text class="iconfont icon-ic_increase"></text>添加标签</view>
				</view>
		...
		<view class="property">
			...
			<view class="info acea-row">
				<view class="item" @click="integralTap">
					...
					<view class="bottom acea-row row-between-wrapper">
						...
						<view class="iconfont icon-ic_edit" v-if="types"></view>
					</view>
				</view>
			...
			<view class="info acea-row">
				<view class="item">
					<view class="acea-row row-between-wrapper">
						<view>优惠券</view>
						<view class="iconfont icon-ic_rightarrow" @click="couponSeeTap" v-if="types"></view>
					</view>
					<view class="bottom acea-row row-between-wrapper">
						<view class="num">{{infoData.coupon_num}}张</view>
						<view class="give" @click="couponTap" v-if="types">赠送</view>
					</view>
				</view>
