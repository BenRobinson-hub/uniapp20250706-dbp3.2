<template>
	<view v-if="pageShow" class="page"
		...
		<view :style="colorStyle">
			<!-- 轮播搜索 -->
			<homeComb v-if="showHomeComb" :dataConfig="homeCombData" :storeInfor='storeInfor' :belongIndex='belongIndex' :special='1' @bindSortId="bindSortId" :isScrolled="isScrolled" @locationTap='locationTap' @storeTap="storeTap"></homeComb>
			<!-- 顶部搜索框 -->
			<headerSerch v-if="isHeaderSerch" :dataConfig="headerSerchCombData" :storeInfor='storeInfor' :belongIndex='belongIndex' :special='1' @locationTap='locationTap' @storeTap="storeTap"></headerSerch>
			...
			<view class="index">
				...
				<block v-for="(item, index) in styleConfig" :key="index">
					...
					<shortVideo v-if="item.name == 'shortVideo'" :dataConfig="item"></shortVideo>
...
<script>
	...
	import storeList from '@/pages/index/components/storeList';
