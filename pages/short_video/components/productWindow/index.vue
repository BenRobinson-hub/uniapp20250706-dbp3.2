				...
				<view class="text">
					...
					<view class="money font-color">
						<view class="top">
							...
							<text class='vip-money' v-if="Number(attr.productSelect.vip_price)>0 && storeInfo && storeInfo.price_type == 'member'">￥{{attr.productSelect.vip_price}}</text>
							<image class="vipImg" v-if="Number(attr.productSelect.vip_price)>0 && storeInfo && storeInfo.price_type == 'member'" src="@/static/images/vip.png" mode=""></image>
							<view class="icon" v-if="Number(attr.productSelect.vip_price)>0 && storeInfo && storeInfo.price_type == 'level'">
