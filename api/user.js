 ...
 * @param {Object} data
 */
export function makeOnceInvoice(data) {
	return request.post('v2/order/make_once_invoice', data);
}
...
export function userCardList() {
	return request.get("v2/user/card/list");
}
...
export function cardHolder(id) {
	return request.get(`v2/card/holder/${id}`);
}
...
export function delCardHolder(id) {
	return request.get(`v2/del/holder/${id}`);
}
