 ...
 * @param {Object} id
 */
export function getReservationInfo(id,data) {
  return request.get(`reservation/product/detail/${id}`,data,{
	  noAuth: true
  });
}
...
export function getReservationDate(id,data) {
  return request.get(`reservation/product/date/${id}`,data,{
	  noAuth: true
  });
}
...
export function getReservationTimes(id,data) {
  return request.get(`reservation/product/times_stock/${id}`,data,{
	  noAuth: true
  });
}
 ...
 * @param {Object} id
 */
export function postReservationCompute(data) {
  return request.post(`reservation/product/compute`,data,{
	  noAuth: true
  });
}
